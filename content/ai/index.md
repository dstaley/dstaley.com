...
I do leverage AI coding tools in my software development workflow. However, I have two guiding principles:

1. I do not "vibe code" software that I intend other people to use.

   While I have found some success with using AI to generate useful scripts and small programs in my work and personal software development where I don't fully review the generated code, I do not feel comfortable associating said code with my name. I know it seems that it's increasingly popular to say you haven't read the code, but I still do. All of it.

1. Surfaces like code comments, documentation, commit messages, and PR descriptions follow my written content policy.

   Since I consider them written content, I do not use AI to generate code comments, documentation, commit messages, or PR descriptions. Even though it can be argued that these are aimed at agents, I believe that the fundamental idea of large language models means that human-centric writing is better understood than AI-generated slop. Code comments in particular are one of the first things I rip out or heavily edit when reviewing AI-generated code. It is exceedingly rare that an AI will, without prompting, include a comment that I find useful.
